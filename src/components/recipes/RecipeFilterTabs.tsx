    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200">
        <div className="flex gap-2 overflow-x-auto scrollbar-hide">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 font-semibold whitespace-nowrap transition-colors border-b-2 ${
              activeTab === 'useCase'
                ? 'border-orange-600 text-orange-600'
                : 'border-transparent text-gray-600 hover:text-gray-900'
            }`}
      ...
      {activeTab === 'useCase' && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900">Browse by Use Case</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            >
              ...
              <div className="text-sm text-gray-600">{getUseCaseCount('all')} recipes</div>
            </button>
            <button
            ...
            >
              ...
              <div className="font-semibold text-gray-900">Pub & Casual Dining</div>
              <div className="text-sm text-gray-600">{getUseCaseCount('pub-casual')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🍽️</div>
              <div className="font-semibold text-gray-900">Fine Dining & Special Occasions</div>
              <div className="text-sm text-gray-600">{getUseCaseCount('fine-dining')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">⚡</div>
              <div className="font-semibold text-gray-900">Quick Lunch Service</div>
              <div className="text-sm text-gray-600">{getUseCaseCount('quick-lunch')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🎉</div>
              <div className="font-semibold text-gray-900">Large Events & Catering</div>
              <div className="text-sm text-gray-600">{getUseCaseCount('large-events')} recipes</div>
            </button>
          </div>
        </div>
      )}
      ...
      {activeTab === 'protein' && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900">Browse by Protein</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <button
            ...
            >
              <div className="text-2xl mb-2">🍖</div>
              <div className="font-semibold text-gray-900">All Proteins</div>
              <div className="text-sm text-gray-600">{getProteinCount('all')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🥩</div>
              <div className="font-semibold text-gray-900">Beef Recipes</div>
              <div className="text-sm text-gray-600">{getProteinCount('BEEF')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🐔</div>
              <div className="font-semibold text-gray-900">Chicken Recipes</div>
              <div className="text-sm text-gray-600">{getProteinCount('CHICKEN')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🐖</div>
              <div className="font-semibold text-gray-900">Pork Recipes</div>
              <div className="text-sm text-gray-600">{getProteinCount('PORK')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🐑</div>
              <div className="font-semibold text-gray-900">Lamb Recipes</div>
              <div className="text-sm text-gray-600">{getProteinCount('LAMB')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🌭</div>
              <div className="font-semibold text-gray-900">Sausage Recipes</div>
              <div className="text-sm text-gray-600">{getProteinCount('SAUSAGES')} recipes</div>
            </button>
          </div>
        </div>
      )}
      ...
      {activeTab === 'difficulty' && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900">Browse by Difficulty</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <button
            ...
            >
              ...
              <div className="text-sm text-gray-600">{getDifficultyCount('all')} recipes</div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-sm text-gray-600">{getDifficultyCount('Easy')} recipes · 3 steps or less</div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-sm text-gray-600">{getDifficultyCount('Medium')} recipes · Requires some prep</div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-sm text-gray-600">{getDifficultyCount('Advanced')} recipes · Chef-level technique</div>
            </button>
          </div>
        </div>
      )}
      ...
      {activeTab === 'season' && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-900">Browse by Season</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <button
            ...
            >
              <div className="text-2xl mb-2">🌍</div>
              <div className="font-semibold text-gray-900">All Seasons</div>
              <div className="text-sm text-gray-600">{getSeasonCount('all')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🌸</div>
              <div className="font-semibold text-gray-900">Spring Specials</div>
              <div className="text-sm text-gray-600">{getSeasonCount('spring')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">☀️</div>
              <div className="font-semibold text-gray-900">Summer BBQ</div>
              <div className="text-sm text-gray-600">{getSeasonCount('summer')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">🍂</div>
              <div className="font-semibold text-gray-900">Autumn Comforts</div>
              <div className="text-sm text-gray-600">{getSeasonCount('autumn')} recipes</div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-2">❄️</div>
              <div className="font-semibold text-gray-900">Winter Warmers</div>
              <div className="text-sm text-gray-600">{getSeasonCount('winter')} recipes</div>
            </button>
          </div>
        </div>
      )}
